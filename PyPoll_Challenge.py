...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (cvotes > largest_county_turnout_count) and cvote_percentage > largest_county_turnout_percentage:
            largest_county_turnout = county_name
            largest_county_turnout_count = cvotes
            largest_county_turnout_percentage = cvote_percentage
